...
// source: chain4energy/c4echain/cfeminter/minter.proto
...
func (*Minter) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d849cb48557a6cd, []int{0}
}
...
func (*NoMinting) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d849cb48557a6cd, []int{1}
}
...
func (*LinearMinting) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d849cb48557a6cd, []int{2}
}
...
func (*ExponentialStepMinting) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d849cb48557a6cd, []int{3}
}
...
func (*MinterState) Descriptor() ([]byte, []int) {
	return fileDescriptor_1d849cb48557a6cd, []int{4}
}
...
func init() {
	proto.RegisterFile("chain4energy/c4echain/cfeminter/minter.proto", fileDescriptor_1d849cb48557a6cd)
}

var fileDescriptor_1d849cb48557a6cd = []byte{
	// 593 bytes of a gzipped FileDescriptorProto
	,
}
