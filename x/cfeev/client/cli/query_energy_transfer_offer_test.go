...
func TestShowEnergyTransferOffer(t *testing.T) {
	net, objs := networkWithEnergyTransferOfferObjects(t, 2)
...
func TestListEnergyTransferOffer(t *testing.T) {
	net, objs := networkWithEnergyTransferOfferObjects(t, 5)
