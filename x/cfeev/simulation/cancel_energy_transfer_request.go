...
func SimulateMsgCancelEnergyTransfer(
	...
	return func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accs []simtypes.Account, chainID string,
		...
		msgCancelEnergyTransfer := &types.MsgCancelEnergyTransfer{
			Creator:          simAccount.Address.String(),
			EnergyTransferId: energyTransferOffer.Id,
			ErrorInfo:        "",
			ErrorCode:        "",
		}
		if err := simulation.SendMessageWithRandomFees(ctx, r, ak.(authkeeper.AccountKeeper), bk.(bankkeeper.Keeper), app, simAccount, msgCancelEnergyTransfer, chainID); err != nil {
			return simtypes.NewOperationMsg(msgCancelEnergyTransfer, false, "", nil), nil, nil
		}

		return simtypes.NewOperationMsg(msgCancelEnergyTransfer, true, "", nil), nil, nil
	}
}
