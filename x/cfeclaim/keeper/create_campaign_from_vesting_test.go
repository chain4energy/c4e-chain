...
func TestAddClaimRecordsFromWhitelistedAccountAllCoinsLocked(t *testing.T) {
	...
	testHelper.C4eClaimUtils.AddClaimRecordsFromWhitelistedVestingAccount(accAddr2, sdk.NewInt(1000), sdk.NewInt(1000))
}
...
func TestAddClaimRecordsFromWhitelistedAccountAllCoinsUnlocked(t *testing.T) {
	...
	testHelper.C4eClaimUtils.AddClaimRecordsFromWhitelistedVestingAccount(accAddr2, sdk.NewInt(500), sdk.NewInt(1000))
}
...
func TestAddClaimRecordsFromWhitelistedAccountHalfOfCoinsUnlocked(t *testing.T) {
	...
	testHelper.C4eClaimUtils.AddClaimRecordsFromWhitelistedVestingAccount(accAddr2, sdk.NewInt(500), sdk.NewInt(500))
}
...
func TestAddClaimRecordsFromWhitelistedAccountHalfOfCoinsUnlockedBiggerAmount(t *testing.T) {
	...
	testHelper.SetContextBlockTime(startTime.Add(time.Hour * 5))
	testHelper.C4eClaimUtils.AddClaimRecordsFromWhitelistedVestingAccount(accAddr2, sdk.NewInt(777), sdk.NewInt(777))
}
...
func TestAddClaimRecordsFromWhitelistedAccountHalfOfCoinsUnlockedAdditionalBalance(t *testing.T) {
	...
	testHelper.C4eClaimUtils.AddCoinsToCampaignOwnerAcc(accAddr2, sdk.NewInt(100))
	testHelper.SetContextBlockTime(startTime.Add(time.Hour * 5))
	testHelper.C4eClaimUtils.AddClaimRecordsFromWhitelistedVestingAccount(accAddr2, sdk.NewInt(777), sdk.NewInt(777))
}
...
func TestAddClaimRecordsFromWhitelistedAccountHalfOfCoinsUnlockedDelegate(t *testing.T) {
	...
	testHelper.SetContextBlockTime(startTime.Add(time.Hour * 5))
	testHelper.C4eClaimUtils.AddClaimRecordsFromWhitelistedVestingAccount(accAddr2, sdk.NewInt(6000), sdk.NewInt(6100))
}
