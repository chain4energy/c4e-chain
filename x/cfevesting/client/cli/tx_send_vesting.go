...
func CmdSendVesting() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "send-vesting [to-address] [vesting-id] [amount] [restart-vesting]",
		Short: "Broadcast message sendVesting",
