...
func init() {
	proto.RegisterType((*VestingTypes)(nil), "chain4energy.c4echain.cfevesting.v1.VestingTypes")
	proto.RegisterType((*VestingType)(nil), "chain4energy.c4echain.cfevesting.v1.VestingType")
}
