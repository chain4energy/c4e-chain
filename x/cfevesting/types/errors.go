...
var (
	...
	ErrParsing                           = sdkerrors.Register(ModuleName, 5, "failed to parse address")
	...
	ErrVestingAvailableSmallerThanAmount = sdkerrors.Register(ModuleName, 13, "vesting pool not found")
