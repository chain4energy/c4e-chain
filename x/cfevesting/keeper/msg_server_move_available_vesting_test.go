...
func TestMoveAvailableVestingError(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{desc: "wrong src addr", srcAddr: "invalid", dstAddr: dstAccAddr.String(), initialVestingAmount: createDenomCoins([]math.Int{sdk.NewInt(8999999999999999999)}), blockTime: startTime.Add(-duration),
		...
		{desc: "wrong dst addr", srcAddr: srcAccAddr.String(), dstAddr: "invalid", initialVestingAmount: createDenomCoins([]math.Int{sdk.NewInt(8999999999999999999)}), blockTime: startTime.Add(-duration),
		...
		{desc: "send disabled", srcAddr: srcAccAddr.String(), dstAddr: dstAccAddr.String(), initialVestingAmount: createDenomCoins([]math.Int{sdk.NewInt(12), sdk.NewInt(12), sdk.NewInt(12)}), blockTime: startTime.Add(-duration),
		...
		{desc: "destination not allowed to received funds", srcAddr: srcAccAddr.String(), dstAddr: blockedAddr.String(), initialVestingAmount: createDenomCoins([]math.Int{sdk.NewInt(12), sdk.NewInt(12), sdk.NewInt(12)}), blockTime: startTime.Add(-duration),
		...
		{desc: "destination account already exists", srcAddr: srcAccAddr.String(), dstAddr: dstAccAddr.String(), initialVestingAmount: createDenomCoins([]math.Int{sdk.NewInt(12), sdk.NewInt(12), sdk.NewInt(12)}), blockTime: startTime.Add(-duration),
		...
		{desc: "nothing to share", srcAddr: srcAccAddr.String(), dstAddr: dstAccAddr.String(), initialVestingAmount: createDenomCoins([]math.Int{sdk.NewInt(12), sdk.NewInt(12), sdk.NewInt(12)}), blockTime: startTime.Add(duration),
