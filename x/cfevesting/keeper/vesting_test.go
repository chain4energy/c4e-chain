...
func TestCalculateWithdrawable(t *testing.T) {
	...
	withdrawable = keeper.CalculateWithdrawable(lockEnd.Add(unlockingPeriod).Add(testutils.CreateDurationFromNumOfHours(-1)), vesting)
	require.EqualValues(t, sdk.ZeroInt(), withdrawable)
	...
	withdrawable = keeper.CalculateWithdrawable(lockEnd.Add(unlockingPeriod), vesting)
	require.EqualValues(t, testutils.GetExpectedWithdrawable(lockEnd, end, unlockingPeriod, lockEnd.Add(unlockingPeriod), amount), withdrawable)
	...
	withdrawable = keeper.CalculateWithdrawable(lockEnd.Add(10*unlockingPeriod), vesting)
	require.EqualValues(t, testutils.GetExpectedWithdrawable(lockEnd, end, unlockingPeriod, lockEnd.Add(10*unlockingPeriod), amount), withdrawable)

	// current block equal to vesting end - witdrawable all = 1000000
	withdrawable = keeper.CalculateWithdrawable(end, vesting)
	...
	withdrawable = keeper.CalculateWithdrawable(end.Add(testutils.CreateDurationFromNumOfHours(-1)), vesting)
	require.EqualValues(t, testutils.GetExpectedWithdrawable(lockEnd, end, unlockingPeriod, end.Add(testutils.CreateDurationFromNumOfHours(-1)), amount), withdrawable)

	// setting VestingEndBlock to whole vesting periof not be divisible by unlocking period
	vesting.VestingEnd = end.Add(testutils.CreateDurationFromNumOfHours(-1))
	...
	withdrawable = keeper.CalculateWithdrawable(lockEnd.Add(10*unlockingPeriod).Add(testutils.CreateDurationFromNumOfHours(-1)), vesting)
	require.EqualValues(t, sdk.ZeroInt(), withdrawable)
	...
	withdrawable = keeper.CalculateWithdrawable(lockEnd.Add(10*unlockingPeriod), vesting)
	require.EqualValues(t, testutils.GetExpectedWithdrawable(lockEnd, end, unlockingPeriod, lockEnd.Add(10*unlockingPeriod), vesting.LastModificationVested), withdrawable)
	...
	withdrawable = keeper.CalculateWithdrawable(lockEnd.Add(10*unlockingPeriod), vesting)
	require.EqualValues(t, testutils.GetExpectedWithdrawable(lockEnd, end, unlockingPeriod, lockEnd.Add(10*unlockingPeriod), vesting.LastModificationVested).Sub(withdrawn), withdrawable)
...
func TestCalculateWithdrawableAfterSendReceivingSide(t *testing.T) {
	...
	require.EqualValues(t, testutils.GetExpectedWithdrawable(startHeight, endHeight, unlockingPeriod, startHeight.Add(unlockingPeriod), amount), withdrawable)
	...
	require.EqualValues(t, testutils.GetExpectedWithdrawable(startHeight, endHeight, unlockingPeriod, startHeight.Add(10*unlockingPeriod), amount), withdrawable)
	...
	require.EqualValues(t, testutils.GetExpectedWithdrawable(startHeight, endHeight, unlockingPeriod, endHeight.Add(testutils.CreateDurationFromNumOfHours(-1)), amount), withdrawable)
	...
	// witdrawable = vested/number of unlocking periods 10*(1000/((110000-10000)/10) = 1)
	withdrawable = keeper.CalculateWithdrawable(startHeight.Add(10*unlockingPeriod), vesting)
	require.EqualValues(t, testutils.GetExpectedWithdrawable(startHeight, endHeight, unlockingPeriod, startHeight.Add(10*unlockingPeriod), vesting.LastModificationVested), withdrawable)
	...
	withdrawable = keeper.CalculateWithdrawable(startHeight.Add(10*unlockingPeriod), vesting)
	require.EqualValues(t, testutils.GetExpectedWithdrawable(startHeight, endHeight, unlockingPeriod, startHeight.Add(10*unlockingPeriod), vesting.LastModificationVested).Sub(withdrawn), withdrawable)
...
func TestCalculateWithdrawableAfterSendSendingSideBeforeLockEnd(t *testing.T) {
	...
	require.EqualValues(t, testutils.GetExpectedWithdrawable(lockEndHeight, endHeight, unlockingPeriod, lockEndHeight.Add(unlockingPeriod), amount), withdrawable)

	// current block 10 unlocking periods more than lock end - witdrawable =  10*vested/number of unlocking periods 10*(1000000/((110000-10000)/10) = 1000)
	withdrawable = keeper.CalculateWithdrawable(lockEndHeight.Add(10*unlockingPeriod), vesting)
	require.EqualValues(t, testutils.GetExpectedWithdrawable(lockEndHeight, endHeight, unlockingPeriod, lockEndHeight.Add(10*unlockingPeriod), amount), withdrawable)
	...
	// current block equal to one block before vesting end - witdrawable all except one unlocking period = 9999*(1000000/((110000-10000)/10) = 999900)
	withdrawable = keeper.CalculateWithdrawable(endHeight.Add(testutils.CreateDurationFromNumOfHours(-1)), vesting)
	require.EqualValues(t, testutils.GetExpectedWithdrawable(lockEndHeight, endHeight, unlockingPeriod, endHeight.Add(testutils.CreateDurationFromNumOfHours(-1)), amount), withdrawable)
	...
	// witdrawable = vested/number of unlocking periods 10*(1000/((110000-10000)/10) = 1)
	withdrawable = keeper.CalculateWithdrawable(lockEndHeight.Add(10*unlockingPeriod), vesting)
	require.EqualValues(t, testutils.GetExpectedWithdrawable(lockEndHeight, endHeight, unlockingPeriod, lockEndHeight.Add(10*unlockingPeriod), vesting.LastModificationVested), withdrawable)
	...
	// current block 10 unlocking periods more than lock end - witdrawable =  10*vested/number of unlocking periods 10*(1000000/((110000-10000)/10) - 500 = 500)
	withdrawable = keeper.CalculateWithdrawable(lockEndHeight.Add(10*unlockingPeriod), vesting)
	require.EqualValues(t, testutils.GetExpectedWithdrawable(lockEndHeight, endHeight, unlockingPeriod, lockEndHeight.Add(10*unlockingPeriod), vesting.LastModificationVested).Sub(withdrawn), withdrawable)
