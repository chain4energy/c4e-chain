...
func TestSendVestingDelegationNotAllowed(t *testing.T) {
	sendVestingDelegation(t, false)
}

func TestSendVestingDelegationAllowed(t *testing.T) {
	sendVestingDelegation(t, true)
}

func sendVestingDelegation(t *testing.T, delegationAllowed bool) {
