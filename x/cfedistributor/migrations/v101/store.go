...
//func getAllV100SubDistributorsAndDelete(store sdk.KVStore, cdc codec.BinaryCodec) (list []v100cfedistributor.SubDistributor, err error) {
...
//		var val v100cfedistributor.AccountVestingPools
...
//}
//
//func setNewAccountVestingPools(store sdk.KVStore, cdc codec.BinaryCodec, oldAccPools []v100cfedistributor.AccountVestingPools) error {
...
//	b := store.Get(v100cfedistributor.VestingTypesKey)
//	if b == nil {
...
//	}
//	store.Delete(v100cfedistributor.VestingTypesKey)
//	return
//}
//
...
//	oldAccountVestingPools, err := getAllV100SubDistributorsAndDelete(store, cdc)
//	if err != nil {
//		return err
//	}
