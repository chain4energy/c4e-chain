...
func ConvertBech32Cmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Convert any bech32 string to the c4e prefix",
		Long: `Convert any bech32 string to the c4e prefix
Especially useful for converting cosmos addresses to c4e addresses

Example:
	c4ed bech32-convert cosmos1ey69r37gfxvxg62sh4r0ktpuc46pzjrmz29g45
	`,
	...
	cmd.Flags().StringP(flagBech32Prefix, "p", "c4e", "Bech32 Prefix to encode to")
