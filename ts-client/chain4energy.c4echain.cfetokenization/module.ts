...
import { FulfilledActivePower as typeFulfilledActivePower} from "./types"

export { MsgBuyCertificate, MsgAssignDeviceToUser, MsgBurnCertificate, MsgAcceptDevice, MsgCreateUserCertificates, MsgAddMeasurement, MsgAuthorizeCertificate, MsgAddCertificateToMarketplace };
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						...
						FulfilledActivePower: getStructure(typeFulfilledActivePower.fromPartial({})),
