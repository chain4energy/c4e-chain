...
function createBaseUserDevices(): UserDevices {
  return { id: 0, owner: "", devices: undefined, creator: "" };
}
...
export const UserDevices = {
  encode(message: UserDevices, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.devices !== undefined) {
      Device.encode(message.devices, writer.uint32(26).fork()).ldelim();
    }
    if (message.creator !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.devices = Device.decode(reader, reader.uint32());
          break;
        case 4:
  ...
  fromJSON(object: any): UserDevices {
    return {
      ...
      devices: isSet(object.devices) ? Device.fromJSON(object.devices) : undefined,
  ...
  toJSON(message: UserDevices): unknown {
    ...
    message.devices !== undefined && (obj.devices = message.devices ? Device.toJSON(message.devices) : undefined);
  ...
  fromPartial<I extends Exact<DeepPartial<UserDevices>, I>>(object: I): UserDevices {
    ...
    message.devices = (object.devices !== undefined && object.devices !== null)
      ? Device.fromPartial(object.devices)
      : undefined;
