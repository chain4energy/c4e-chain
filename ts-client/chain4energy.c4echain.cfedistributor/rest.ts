...
export interface CfedistributorAccount {
  id?: string;
  type?: string;
}
 ...
 */
export interface CfedistributorParams {
  sub_distributors?: CfedistributorSubDistributor[];
}
...
export interface CfedistributorQueryStatesResponse {
  states?: CfedistributorState[];
