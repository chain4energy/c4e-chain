...
import { NewCampaign as typeNewCampaign} from "./types"
import { CloseCampaign as typeCloseCampaign} from "./types"
import { RemoveCampaign as typeRemoveCampaign} from "./types"
import { EnableCampaign as typeEnableCampaign} from "./types"
import { AddMission as typeAddMission} from "./types"
import { Claim as typeClaim} from "./types"
import { InitialClaim as typeInitialClaim} from "./types"
import { AddClaimRecords as typeAddClaimRecords} from "./types"
import { DeleteClaimRecord as typeDeleteClaimRecord} from "./types"
import { CompleteMission as typeCompleteMission} from "./types"
import { Mission as typeMission} from "./types"

export { MsgEnableCampaign, MsgDeleteClaimRecord, MsgRemoveCampaign, MsgAddMission, MsgAddClaimRecords, MsgCloseCampaign, MsgInitialClaim, MsgCreateCampaign, MsgClaim };
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						...
						NewCampaign: getStructure(typeNewCampaign.fromPartial({})),
						CloseCampaign: getStructure(typeCloseCampaign.fromPartial({})),
						RemoveCampaign: getStructure(typeRemoveCampaign.fromPartial({})),
						EnableCampaign: getStructure(typeEnableCampaign.fromPartial({})),
						AddMission: getStructure(typeAddMission.fromPartial({})),
						Claim: getStructure(typeClaim.fromPartial({})),
						InitialClaim: getStructure(typeInitialClaim.fromPartial({})),
						AddClaimRecords: getStructure(typeAddClaimRecords.fromPartial({})),
						DeleteClaimRecord: getStructure(typeDeleteClaimRecord.fromPartial({})),
						CompleteMission: getStructure(typeCompleteMission.fromPartial({})),
