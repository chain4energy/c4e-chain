...
run_simulation(){
  ...
  do
    ...
    then
        ...
        #curl -F file=@"$simulationResultFileError" -F "initial_comment=$START_TIME" -F channels=C049DAHR884 -H "Authorization: Bearer xoxb-89841793824-4319406644228-odhbQhFoRpzxJxDbfooS23u8" https://slack.com/api/files.upload
    fi
    done
}
