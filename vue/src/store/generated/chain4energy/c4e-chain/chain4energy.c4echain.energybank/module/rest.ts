...
export interface EnergybankEnergyToken {
  /** @format uint64 */
  id?: string;
  name?: string;
 ...
 */
export type EnergybankParams = object;

export interface EnergybankQueryAllEnergyTokenResponse {
...
export interface EnergybankQueryAllTokenParamsResponse {
  tokenParams?: EnergybankTokenParams[];
...
export interface EnergybankQueryGetTokenParamsResponse {
  tokenParams?: EnergybankTokenParams;
}
 ...
 */
export interface EnergybankQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: EnergybankParams;
}

export interface EnergybankTokenParams {
  index?: string;
  name?: string;
