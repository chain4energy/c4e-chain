...
import { Remains } from "./module/types/cferoutingdistributor/sub_distributor"
import { RemainsList } from "./module/types/cferoutingdistributor/sub_distributor"
...
export { Params, Remains, RemainsList, RoutingDistributor, SubDistributor, Destination, BurnShare, Share, Account };
...
const getDefaultState = () => {
	return {
				...
				_Structure: {
						...
						Remains: getStructure(Remains.fromPartial({})),
						RemainsList: getStructure(RemainsList.fromPartial({})),
