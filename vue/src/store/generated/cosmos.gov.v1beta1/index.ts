...
import { WeightedVoteOption } from "chain4energy-c4e-chain-client-ts/cosmos.gov.v1beta1/types"
import { TextProposal } from "chain4energy-c4e-chain-client-ts/cosmos.gov.v1beta1/types"
import { Deposit } from "chain4energy-c4e-chain-client-ts/cosmos.gov.v1beta1/types"
import { Proposal } from "chain4energy-c4e-chain-client-ts/cosmos.gov.v1beta1/types"
import { TallyResult } from "chain4energy-c4e-chain-client-ts/cosmos.gov.v1beta1/types"
import { Vote } from "chain4energy-c4e-chain-client-ts/cosmos.gov.v1beta1/types"
import { DepositParams } from "chain4energy-c4e-chain-client-ts/cosmos.gov.v1beta1/types"
import { VotingParams } from "chain4energy-c4e-chain-client-ts/cosmos.gov.v1beta1/types"
import { TallyParams } from "chain4energy-c4e-chain-client-ts/cosmos.gov.v1beta1/types"
