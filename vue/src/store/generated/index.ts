...
import Chain4EnergyC4EchainCfetokenization from './chain4energy.c4echain.cfetokenization'
...
export default { 
  ...
  Chain4EnergyC4EchainCfetokenization: load(Chain4EnergyC4EchainCfetokenization, 'chain4energy.c4echain.cfetokenization'),
