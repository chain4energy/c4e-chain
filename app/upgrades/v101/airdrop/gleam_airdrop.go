...
var gleamContestRecords = []*types.AirdropEntry{
	{
		...
		AirdropCoins: sdk.NewCoins(sdk.NewCoin("uc4e", sdk.NewInt(10000))),
	},
	{
		Address:      "c4e1uqenz7vu5xyxfsr70was6zzf5g3spsy52lenlc",
		AirdropCoins: sdk.NewCoins(sdk.NewCoin("uc4e", sdk.NewInt(20000))),
	},
	{
		Address:      "c4e17dffs6qldsh30un0jm68ggr40rzkm7tmvh0e78",
		AirdropCoins: sdk.NewCoins(sdk.NewCoin("uc4e", sdk.NewInt(30000))),
	},
}
