...
func TestModifyVestingAccountsNoAccounts(t *testing.T) {
	testHelper := testapp.SetupTestAppWithHeight(t, 1000)

	require.Nil(t, testHelper.App.AccountKeeper.GetAccount(testHelper.Context, sdk.MustAccAddressFromBech32(v120.Account1)))
	require.Nil(t, testHelper.App.AccountKeeper.GetAccount(testHelper.Context, sdk.MustAccAddressFromBech32(v120.Account2)))
	require.Nil(t, testHelper.App.AccountKeeper.GetAccount(testHelper.Context, sdk.MustAccAddressFromBech32(v120.Account3)))
	require.Nil(t, testHelper.App.AccountKeeper.GetAccount(testHelper.Context, sdk.MustAccAddressFromBech32(v120.Account4)))
...
func TestModifyVestingAccountsWrongAccountsTypes(t *testing.T) {
	testHelper := testapp.SetupTestAppWithHeight(t, 1000)

	testHelper.AuthUtils.CreateDefaultDenomBaseAccount(v120.Account1, math.NewInt(8899990000000))
	testHelper.AuthUtils.CreateDefaultDenomBaseAccount(v120.Account2, math.NewInt(6574990000000))
	testHelper.AuthUtils.CreateDefaultDenomBaseAccount(v120.Account3, math.NewInt(6574990000000))
	testHelper.AuthUtils.CreateDefaultDenomBaseAccount(v120.Account4, math.NewInt(2949990000000))

	acc1 := testHelper.App.AccountKeeper.GetAccount(testHelper.Context, sdk.MustAccAddressFromBech32(v120.Account1))
	acc2 := testHelper.App.AccountKeeper.GetAccount(testHelper.Context, sdk.MustAccAddressFromBech32(v120.Account2))
	acc3 := testHelper.App.AccountKeeper.GetAccount(testHelper.Context, sdk.MustAccAddressFromBech32(v120.Account3))
	acc4 := testHelper.App.AccountKeeper.GetAccount(testHelper.Context, sdk.MustAccAddressFromBech32(v120.Account4))

	require.NoError(t, v120.ModifyVestingAccountsState(testHelper.Context, testHelper.App))

	acc1After := testHelper.App.AccountKeeper.GetAccount(testHelper.Context, sdk.MustAccAddressFromBech32(v120.Account1))
	acc2After := testHelper.App.AccountKeeper.GetAccount(testHelper.Context, sdk.MustAccAddressFromBech32(v120.Account2))
	acc3After := testHelper.App.AccountKeeper.GetAccount(testHelper.Context, sdk.MustAccAddressFromBech32(v120.Account3))
	acc4After := testHelper.App.AccountKeeper.GetAccount(testHelper.Context, sdk.MustAccAddressFromBech32(v120.Account4))
...
func TestModifyVestingAccountsMix(t *testing.T) {
	testHelper := testapp.SetupTestAppWithHeight(t, 1000)
