...
import (
	...
	v200 "github.com/chain4energy/c4e-chain/v2/app/upgrades/v200"
	...
	v110 "github.com/chain4energy/c4e-chain/v2/app/upgrades/v110"
	...
	"github.com/chain4energy/c4e-chain/v2/docs"
	cfeclaimmodule "github.com/chain4energy/c4e-chain/v2/x/cfeclaim"
	cfedistributormodule "github.com/chain4energy/c4e-chain/v2/x/cfedistributor"
	...
	cfemintermodule "github.com/chain4energy/c4e-chain/v2/x/cfeminter"
	...
	cfevestingmodule "github.com/chain4energy/c4e-chain/v2/x/cfevesting"
...
func New(
	...
	app.ConsensusParamsKeeper = consensusparamkeeper.NewKeeper(appCodec, keys[upgradetypes.StoreKey], appparams.GetAuthority())
	...
	*/
	...
	app.StakingKeeper.SetHooks(
		stakingtypes.NewMultiStakingHooks(
			...
			app.CfeclaimKeeper.NewMissionDelegationHooks(),
		),
	)
